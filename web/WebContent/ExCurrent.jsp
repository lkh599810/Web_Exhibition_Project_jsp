			...
			<ul>
			    ...
			    int today = Integer.valueOf(format1.format(time));
					...
					for(int i=0; i<exlist.size(); i++){
						...
						String year= exhibition.getExEnd().substring(0, 4);
						String month= exhibition.getExEnd().substring(5,7);
						String day= exhibition.getExEnd().substring(8,10);
						String end = year+month+day;
						int exEnd = Integer.valueOf(end);  //전시회 종료기간
					
						if(exStart<today && today<exEnd){ // 진행 중 %>
								<li>
