...
public class memberupdatecontroller implements Initializable {
	...
	@Override
	public void initialize(URL arg0, ResourceBundle arg1) { // 폼이 열렸을때 초기값
	...
	public void changeAction() {
		...
		DAO dao = DAO.getDB();
		int result =   dao.updatemember(txtpassword.getText(), txtname.getText(), Logincontroller.getinstance().userid());
		
		if( result == 1 ) { // 변경 성공 
			Alert alert2 = new Alert( AlertType.INFORMATION );
			
			alert2.setContentText(" 정상적으로 변경 되었습니다 ");
			alert2.setTitle("알림");
